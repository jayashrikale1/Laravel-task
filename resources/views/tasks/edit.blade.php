        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <select class="form-select" id="user_id" name="user_id" required>
                    ...
                    @foreach ($users as $user)
                        <option value="{{ $user->id }}" @selected((string)$user->id === old('user_id', (string)$task->user_id))>{{ $user->name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" id="due_date" name="due_date" type="date" value="{{ old('due_date', optional($task->due_date)->format('Y-m-d')) }}" required>
                </div>
            </div>
            <div class="mt-3">
